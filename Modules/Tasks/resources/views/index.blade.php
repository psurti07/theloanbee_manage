...
@section('breadcrumb-items')
    ...
    <li class="breadcrumb-item active">Partner Task</li>
@endsection
...
@section('content')
    ...
    <div class="addPartnerTasksModals"></div>
@endsection
...
@push('script-src')
    ...
    @include('stacks.js.modules.tasks.partner.index')
@endpush
@push('script-tag')
