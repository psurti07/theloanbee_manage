<div class="modal fade" id="addLinks" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" >
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form action="{{route('manage.apply.links.store')}}" class="save-links-form" id="save-links-form" method="post">
                <div class="modal-body">
                    <div class="row g-3">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <small>(In %)</small>
                            <input type="number" class="form-control" step="0.5" name="roi" id="roi" min="7" max="40">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="number" class="form-control" step="1" name="tenures" id="tenures" min="12" max="60">
                            ...
                            <div class="checkbox-checked">
                                ...
                                <div class="form-check-size">
                                    <div class="form-check form-check-inline radio radio-primary">
                                        <input class="form-check-input" id="radioinline1" type="radio" name="status_type" value="1" checked="">
                                        <label class="form-check-label mb-0" for="radioinline1">Salaried</label>
                                    </div>
                                    <div class="form-check form-check-inline radio radio-primary">
                                        <input class="form-check-input" id="radioinline2" type="radio" name="status_type" value="2">
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <textarea name="applyurl" class="form-control" placeholder="" id="applyurl" value="{{old('applyurl')}}"></textarea>
                            @component('components.ajax-error',['field'=>'applyurl'])@endcomponent
                        </div>
                        @foreach($criterias as $criteria)
                        <div class="form-group col-md-4">
                            <input class="form-check-input" id="flexCheckDefault{{ $loop->iteration }}" type="checkbox" value="{{ $criteria->id }}" name="criteria[]">
                            <label class="form-check-label" for="flexCheckDefault{{ $loop->iteration }}">&nbsp;{{ $criteria->criteria }}</label>
                        </div>
                        @endforeach
                        <div class="form-check form-switch">
                            <input class="form-check-input" id="flexSwitchCheckChecked" type="checkbox" role="switch" name="is_recommended" value="1">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" id="links-btn" class="btn btn-outline-primary">Add</button>
                </div>
            </form>
        </div>
    </div>
...
<script>
    $('.save-links-form').submit(function(event) {
