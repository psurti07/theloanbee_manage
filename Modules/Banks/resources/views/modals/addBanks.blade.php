<div class="modal fade" id="addBanks" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" >
    <div class="modal-dialog  modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Add Banks</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form action="{{route('manage.banks.save')}}" class="save-banks-form" id="save-banks-form" enctype="multipart/form-data" method="post">
                <div class="modal-body">
                    <input type="hidden" name="rec_date" value="{{ date('Y-m-d H:i:s') }}">
                    <div class="row">
                        <div class="form-group col-md-6 mb-3">
                            <label>Bank Name<span class="text-danger">*</span></label>
                            <input type="text" class="form-control input-air-primary" name="bank_name" id="bank_name" value="{{old('bank_name')}}" placeholder="Bank Name">
                            @component('components.ajax-error',['field'=>'bank_name'])@endcomponent
                        </div>
                        <div class="form-group col-md-6 mb-3">
                            <label>Order No<span class="text-danger">*</span></label>
                            <input type="number" min="0" step="1" class="form-control input-air-primary" name="order_no" id="order_no" value="{{old('order_no')!=''?old('order_no'):0}}" placeholder="Order No">
