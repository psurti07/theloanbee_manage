...
@section('title', 'Self Apply Process Steps Statistics')
...
<h3>Self Apply Process Steps Statistics</h3>
@endsection

@section('breadcrumb-items')
<li class="breadcrumb-item"><a href="{{ route('manage.dashboard') }}">Dashboard</a></li>
<li class="breadcrumb-item active">SA Process Steps</li>
@endsection
...
<div class="container-fluid">
    <div class="row mb-5">
        <div class="col-12 text-end d-inline align-content-end">
            <form method="post" action="{{ route('manage.statistics.self.apply.process.steps') }}" class="filterForm" id="filterForm">
                @csrf
                <div class="row g-3">
